...
class _SelfNotesScreenState extends State<SelfNotesScreen>
  ...
  final String mobileNo = '8459906102'; // Hardcoded mobile number for request
  ...
  Future<void> _fetchNotes() async {
    final String apiUrl =
        'https://67fb-103-174-140-112.ngrok-free.app/api/v1/notes/$mobileNo'; // Your API endpoint
  ...
  Future<void> _addNoteToApi(String title, String content) async {
    final String apiUrl =
        'https://67fb-103-174-140-112.ngrok-free.app/api/v1/notes/userNotes'; // POST endpoint
